...
urlpatterns = [
    ...
    url(r'^explore_words/(?P<source_id>.*)/$', views.explore_new_words, name='explore_words'),
    ...
    url(r'^source_words/(?P<source_id>.*)/(?P<status_filter>.*)/$', views.source_words, name='source_words'),
    url(r'^source_words/(?P<source_id>.*)/$', views.source_words, name='source_words'),
